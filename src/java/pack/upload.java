                ...
                while (it.hasNext()) {
                    ...
                    if (isFormField) {
                        ...
                        try {
                            ...
                            PreparedStatement ps = con.prepareStatement("insert into register(name, pass, repass, gender, dob, acno, bname, address, cno ,pimage,rcount,status,user,reador,code)values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                            ps.setString(1, name);
                            ps.setString(2, pass);
