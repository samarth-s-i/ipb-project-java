                    ...
                    <div class="htext">
                        ...
                        <table style="border-style: solid;border-collapse: collapse" border="5">
                            <tr style="background-color: burlywood">
                                <td align="center" width="5%">NAME</td><br><td>PASSWORD</td><br><td>CARD NO</td><td>BANK</td><td>BRANCH</td><td>PHONE NO</td><td>STATUS</td><td>ACTIVATE</td>
                            </tr>
                            <%                  while (rt.next()) {
