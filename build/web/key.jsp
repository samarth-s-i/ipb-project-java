            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse appiNav">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="key.jsp">User Keys</a></li>
        ...
        <div id="topWrap" class="jumbotron">
            <div class="container">
                <div class="col-md-6 col-md-push-6 jumboText">
                    ...
                    %>
                    <div class="htext">
                        <h2>GENERATE USER KEYS</h2>
                        <table style="border-style: solid;border-collapse: collapse" border="5">
                            <tr style="background-color: burlywood">
                                <td align="center" width="5%">NAME</td><br><td>PASSWORD</td><br><td>CARD NO</td><td>BANK</td><td>BRANCH</td><td>PHONE NO</td><td>PRIVATE KEY</td><td>KEY</td>
                            </tr>
                            <%                  while (rt.next()) {
