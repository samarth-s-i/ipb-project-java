			...
			<div class="container">
				<div class="col-md-6 col-md-push-6 jumboText">
				 <%
                        ...
                        ResultSet rt = st.executeQuery("select *from withdrawals  ");
                        

   %>
      <div class="htext">
    <h2>Withdrawal Transaction Process</h2>
                        <table style="border-style: solid;border-collapse: collapse" border="5">
                            <tr style="background-color: burlywood">
                                <td align="center" width="5%">NAME</td><br><td>CARD NO</td><br><td>BANK NAME</td><td>WITHDRAWAL</td><td>STATUS</td><td>VERIFY</td>
                            </tr>
                            <%                  while (rt.next()) {
                            ...
                            <b><td>
                                    <%
                                        if(status.equals("transaction done"))
                                            ...
                                            <a href="tx1.jsp?<%=acno%> " >Verify Process</a>
                                            <%  }
                                     %>
