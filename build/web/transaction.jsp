...
<html lang="en">
    ...
    <body>
        ...
        --%>
        <%                String name, bank, acc;
            HttpSession session3 = request.getSession(true);
            name = (String) session3.getAttribute("uname");
            bank = (String) session3.getAttribute("bank");
            acc = (String) session3.getAttribute("acc");
            ...
            <div class="container">
                <div class="col-md-6 col-md-push-6 jumboText">
                    <%                                     Connection con = Dbconn.getConnection();
                        ...
                        ResultSet rt = st.executeQuery("select *from transaction");


                    %>
                    <div class="htext">
                        <h2>Deposit Transaction Process</h2>
                        <table style="border-style: solid;border-collapse: collapse" border="5">
                            <tr style="background-color: burlywood">
                                <td align="center" width="5%">NAME</td><br><td>ACCOUNT NO</td><br><td>BANK NAME</td><td>DEPOSIT</td><td>STATUS</td><td>VERIFY</td>
                            </tr>
                            <%                  while (rt.next()) {
                                    ...
                                    String deposit = rt.getString("deposit");
                            ...
                            <b><td>
                                    <%
                                        if(status.equals("transaction done"))
                                            out.print("Completed");
                                        else {%>
                                        
                                            <a href="tx.jsp?<%=uname%>">Verify Process</a>
                                            <%  }
                                     %>
                                </td>
                            </b>
                ...
                <div class="col-md-6 col-md-pull-6 hidden-xs">
                    <div class="mobile">
                        <div class="mobileSlider">
                            <ul class="slides">
                                <li>
                                    <img src="assets/img/transaction.jpg"/>
                                </li>
