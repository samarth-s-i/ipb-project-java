...
<!--						<a class="navbar-brand" href="#topWrap">
   ...
   %>
      <div class="htext">
    <h2>ONLINE ATTACKER</h2>
                        <table style="border-style: solid;border-collapse: collapse" border="5">
                            <tr style="background-color: burlywood">
                                <td align="center" width="5%">NAME</td><br><td>PASSWORD</td><br><td>CARD NO</td><td>BANK</td><td>BRANCH</td><td>PHONE NO</td>
                            </tr>
                            <%                  while (rt.next()) {
