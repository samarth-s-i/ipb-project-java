...
b = (String) session1.getAttribute("bank");
			...
			<div class="container">
				<div class="col-md-6 col-md-push-6 jumboText">
				 <%
                        ...
                        ResultSet rt = st.executeQuery("select * from register where name='"+name+"' AND bname='"+b+"' ");
    ...
    <h2>USER BANK DETAILS</h2>
                        <table style="border-style: solid;border-collapse: collapse" border="5">
                            <tr style="background-color: burlywood">
                                <td align="center" width="5%">NAME</td><td>PASSWORD</td><td>CARD</td><td>BANK</td><td>BRANCH</td><td>PHONE NO</td><td>STATUS</td><td>NEW CARD</td>
                            </tr>
                            <%                  while (rt.next()) {
