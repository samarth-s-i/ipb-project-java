...
<!DOCTYPE html>
	<html lang="en">
		<head>
			...
			<title>IPB - Deposit Details</title>
...
<!--						<a class="navbar-brand" href="#topWrap">
					...
					<div class="collapse navbar-collapse appiNav">
						...
						<li><a href="vuser.jsp">Consumer Details</a></li>
			...
			<div class="container">
				<div class="col-md-6 col-md-push-6 jumboText">
				 <%
                        ...
                        ResultSet rt = st.executeQuery("select *from transaction where bname='"+name+"'");
    ...
    <h2>Deposit details</h2>
                        <table style="border-style: solid;border-collapse: collapse" border="5">
                            <tr style="background-color: burlywood">
                                <td align="center" width="5%">NAME</td><br><td>CARD NO</td><br><td>BANK NAME</td><td>DEPOSIT</td><td>STATUS</td>
                            </tr>
                            <%                  while (rt.next()) {
				...
				<div class="col-md-6 col-md-pull-6 hidden-xs">
					<div class="mobile">
						<div class="mobileSlider">
							<ul class="slides">
								<li>
									<img src="assets/img/deposits1.jpg"/>
								</li>
								<li>
