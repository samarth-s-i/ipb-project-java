			...
			<div class="container">
				<div class="col-md-6 col-md-push-6 jumboText">
				 <%
                        ...
                        ResultSet rt = st.executeQuery("select * from vendor ");
    ...
    <h2>VENDORS</h2>
                        <table style="border-style: solid;border-collapse: collapse" style="width:100%">
                            <tr style="background-color: burlywood">
                                <td width="5%">NAME</td><td>PASSWORD</td><td>BANK</td><td>BRANCH</td><td>PHONE NO</td><td>STATUS</td><td>BINARY</td><td>ACTIVATE</td>
                            </tr>
                            <%                  while (rt.next()) {
                                    ...
                                    String address = rt.getString("branch");
                                    String status = rt.getString("status");
                                    String key = rt.getString("binary");



                            %>
                            <tr>
                                <td><%=uname%></td><td align="center"><%=pass%></td><td><%=bname%></td><td><%=address%></td><td><%=cno%></td><td><%=status%></td><td><%=key%></td>
                                <td><a href="binarycode.jsp?<%=uname%>" >Activate</a></td>
                            </tr>
                            <%
                                }
                                con.close();
