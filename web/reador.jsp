    ...
    <h2>USERS</h2>
                        <table style="border-style: solid;border-collapse: collapse" border="5">
                            <tr style="background-color: burlywood">
                                <td align="center" width="5%">NAME</td><td>PASSWORD</td><td>CARDNO</td><td>BANK</td><td>BRANCH</td><td>PHONE NO</td><td>STATUS</td><td>NEW CARD</td>
                            </tr>
                            <%                  while (rt.next()) {
                            ...
                            <tr>
                                ...
                                <td><a href="cactivate.jsp?<%=acno%>" >GENERATE NEW CARD</a></td>
                            </tr>
                            <%
                                }
                                con.close();
