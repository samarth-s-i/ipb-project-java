...
<!DOCTYPE html>
	<html lang="en">
		...
		<body>
            ...
            name = (String) session1.getAttribute("bank");
...
<!--						<a class="navbar-brand" href="#topWrap">
					...
					<div class="collapse navbar-collapse appiNav">
						<ul class="nav navbar-nav">
							<li><a href="">Consumer Details</a></li>
                                                        <li><a href="ddetails.jsp">Deposit details</a></li>
                                                          <li><a href="wdetails.jsp">Withdrawal Details</a></li>
			...
			<div class="container">
				<div class="col-md-6 col-md-push-6 jumboText">
				 <%
                        ...
                        ResultSet rt = st.executeQuery("select * from register where bname='"+name+"'");
    ...
    <h2>Consumer</h2>
                        <table style="border-style: solid;border-collapse: collapse" border="5" >
                            <tr style="background-color: burlywood">
                                <td align="center" width="5%">NAME</td><br><td>PASSWORD</td><br><td>CARD NO</td><td>BANK</td><td>BRANCH</td><td>PHONE NO</td></tr>
                            <%                  while (rt.next()) {
                            ...
                            %>
                            <tr>
                                <td><%=uname%></td><td align="center">****</td><td><%=acno%></td><td><%=bname%></td><td><%=address%></td><td><%=cno%></td>
                                </tr>
                            <%
                                }
                                con.close();
