...
<!--						<a class="navbar-brand" href="#topWrap">
					...
					<div class="collapse navbar-collapse appiNav">
						<ul class="nav navbar-nav">
							<li><a href="vendors.jsp">Profile</a></li>
    ...
    <h2>Vendor Profile</h2>
                        <table style="border-style: solid;border-collapse: collapse" style="width:100%">
                            <tr style="background-color: burlywood">
                                <td width="5%">NAME</td><td>PASSWORD</td><td>BANK</td><td>BRANCH</td><td>PHONE NO</td><td>STATUS</td><td>ACTIVATE</td>
                            </tr>
                            <%                  while (rt.next()) {
                            ...
                            %>
                            <tr>
                                <td><%=uname%></td><td align="center">****</td><td><%=bname%></td><td><%=address%></td><td><%=cno%></td><td><%=status%></td>
                                <td><a href="vactivate.jsp?<%=uname%>" >Activate</a></td>
                            </tr>
                            <%
                                }
                                con.close();
