        ...
        <div id="topWrap" class="jumbotron">
            <div class="container">
                <div class="col-md-6 col-md-push-6 jumboText">
                    <h2 style="font-size:50px ">IPB</h2>
                    <h1>We provide solution for the semi-offline payments!</h1>
                    <p>For more info-<br/>Contact us: payments_info@ipb.com</p>
