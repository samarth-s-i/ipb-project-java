...
<!--						<a class="navbar-brand" href="#topWrap">
			...
			<div class="container">
				<div class="col-md-6 col-md-push-6 jumboText">
					<h2>Transaction</h2>
                                        <form style="color:black;"action="ctransaction.jsp" method="post">
                                            <label style="font-size: 20px;color:grey;">User Key:&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" class="textbox" placeholder="" required style="margin-left:" name="key"/>
                                           <br/><br/>
                                           <label style="font-size: 20px;color:grey;">BinaryNo:&nbsp;&nbsp;&nbsp;</label><input type="text" class="textbox" placeholder="" required style="margin-left:" name="binary"/><br /><br />
                     
                    <centre> <input type="submit" class="myButton" style="margin-left: 150px" value="Verify"/></centre>
                                 </div>
