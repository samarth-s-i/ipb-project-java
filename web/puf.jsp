...
<!--						<a class="navbar-brand" href="#topWrap">
			...
			<div class="container">
				...
				<h2 style="font-size:50px ">Advanced Re- Verification of each Banking Transaction with security analysis</h2>	<!--<a class="btn btn-lg btn-success actionBtn" href="#"><i class="fa fa-mobile fa-4x pull-left"></i><span class="line1">Available on the</span><br/><span class="line2">App Store</span></a>-->
				</div>
